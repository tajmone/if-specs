...
****[1.0]* The interpreter is required to be able to print representations of every defined Unicode character under *$0100* (i.e. of every defined ISO 8859-1 Latin1 character).
...
****[1.0]* An interpreter is not required to have suitable letter-forms for printing Unicode characters *$0100* to *$FFFF*.
