...
# "zmachine/adoc-srcc/build.sh"                            | v0.0.1 | 2021/01/06
# ------------------------------------------------------------------------------
...
#
# ------------------------------------------------------------------------------
source=zmachine.asciidoc

HTML_output=Z-Machine-Standards.html
HTML_outDir=..
HTML_TOCLev=5
# WWW=../docs/index.html

# ADoc_output=../hGlulx-Specification.asciidoc
...
# ==========================
# printBanner "Building the Glulx Specs"
...
# ======================
# printHeading1 "Z-Machine Standards: Build HTML Document"
...
# =======================================
# printHeading1 "Glulx Specs: Build Standalone AsciiDoc Document"
